...
# Import the blueprint object from this package's __init__.py
from . import bp

@bp.route('/')
def index():
    """Main dashboard page - Sales Overview"""
    df = current_app.df
    ...
    # Pass an 'active_tab' variable to the template
    return render_template('index.html', kpis=kpis, active_tab='sales-overview')